...
* 학생들이 학교 커뮤니티 앱에서 가게 정보 공유하는 것을 확인
<br/><br/><br/>
...
우리도 이러한 기법을 긍정적으로 생각하여 어플로만 작성했었던 리뷰를 식당 내부에서 QR코드를 이용하여 작성하는 방법으로 기존 시장의 틀을 깨고 새로운 방법을 도입하여 사람들에게 리뷰를 작성하는 행위를 적극적으로 유도 하게 한다.<br>
